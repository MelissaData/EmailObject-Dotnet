...
2.  If you already have the latest DQS Release (ZIP), you can find the data files and dlls in there
	...
	- Copy all the dlls mentioned above into the `MelissaDataEmailObjectWindowsNETExample` project folder
...
Parameters:
- -email (optional): a test email address
...
- Command Line 
	...
	You can pass an email address in ```-email``` parameter to test Email object. For example:
	```
