# Melissa Data Email Object Windows Net Example


## Purpose

This is an example of the Melissa Data Email Object using C#
...
2.  If you already have the latest DQS Release (ZIP), you can find the data file(s) and dll(s) in there
	...
	- Copy all the dll(s) mentioned above into the `MelissaDataEmailObjectWindowsNETExample` project folder.

----------------------------------------

#### Configure Target Framework

Depending on your target .NET framework, you may need to configure the powershell script. In order to do this, open up the `MelissaDataEmailObjectWindowsNETExample.ps1` for editing, proceed to the bottom of the script where you will find this section of code.
...
- Interactive 
	...
	```
	$ .\MelissaDataEmailObjectWindowsNETExample.ps1
	```
    For quiet mode:
    ```
    $ .\MelissaDataEmailObjectWindowsNETExample.ps1 -quiet
    ```
- Command Line 
	...
	```
    $ .\MelissaDataEmailObjectWindowsNETExample.ps1 -email "info@melissa.com"
    $ .\MelissaDataEmailObjectWindowsNETExample.ps1 -email "info@melissa.com" -license "<your_license_string>"
    ```
	For quiet mode:
    ```
    $ .\MelissaDataEmailObjectWindowsNETExample.ps1 -email "info@melissa.com" -quiet
    $ .\MelissaDataEmailObjectWindowsNETExample.ps1 -email "info@melissa.com" -license "<your_license_string>" -quiet
    ```
